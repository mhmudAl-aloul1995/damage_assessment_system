...
<head>
    ...
    <style>
        ...
        .cover { background: #0f4c81; color: #fff; text-align: center; padding-top: 55mm; height: 130mm; }
        ...
        h3 { color: #0f4c81; font-size: 12pt; margin: 3mm 0; }
        ...
        .map { border: 1px solid #d7e8f1; height: 60mm; text-align: center; background: #f7fbfd; }
        .chart td { border: 0; padding: 1mm; font-size: 8pt; }
...
<div class="cover">
    ...
    <p>Damage Assessment System - PHC</p>
    <p>{{ $reportDate }}</p>
</div>
...
<div class="page">
    ...
    <h2>نتائج وإحصائيات مشروع المنظومة الوطنية المتكاملة لحصر الأضرار - قطاع غزة</h2>
    <table class="stats">
        <tr>
...
<div class="page">
    ...
    <div class="note">
        تشمل التحديات تفاوت اكتمال بيانات المواقع، وجود قيم غير محددة في بعض الحقول، وتعدد صيغ أسماء المحافظات.
