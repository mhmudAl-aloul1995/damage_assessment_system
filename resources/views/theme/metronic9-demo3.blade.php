...
-->
<!DOCTYPE html>
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}" lang="{{ app()->getLocale() }}">
 <head>
  <title>Metronic 9 Demo3 - {{ __('ui.app.name') }}</title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo3/index.html" rel="canonical"/>
  ...
  <meta content="{{ asset('assets/metronic9/media/app/og-image.png') }}" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo3/index.html" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS " property="og:title"/>
  <meta content="" property="og:description"/>
  <meta content="{{ asset('assets/metronic9/media/app/og-image.png') }}" property="og:image"/>
  <link href="{{ asset('assets/metronic9/media/app/apple-touch-icon.png') }}" rel="apple-touch-icon" sizes="180x180"/>
  <link href="{{ asset('assets/metronic9/media/app/favicon-32x32.png') }}" rel="icon" sizes="32x32" type="image/png"/>
  <link href="{{ asset('assets/metronic9/media/app/favicon-16x16.png') }}" rel="icon" sizes="16x16" type="image/png"/>
  <link href="{{ asset('assets/metronic9/media/app/favicon.ico') }}" rel="shortcut icon"/>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet"/>
  <link href="{{ asset('assets/metronic9/vendors/apexcharts/apexcharts.css') }}" rel="stylesheet"/>
  <link href="{{ asset('assets/metronic9/vendors/keenicons/styles.bundle.css') }}" rel="stylesheet"/>
  <link href="{{ asset('assets/metronic9/css/styles.css') }}" rel="stylesheet"/>
  <style>
   .phc-m9-native-sidebar-note {
    display: none;
   }

   .phc-m9-sidebar-dropdown {
 ...
 <body class="antialiased flex h-full text-base text-foreground bg-background [--header-height:58px] [--sidebar-width:58px] [--navbar-height:56px] lg:overflow-hidden bg-muted">
    ...
    <div class="kt-container-fluid flex justify-between items-stretch px-5 lg:ps-0 lg:gap-4" id="header_container">
     <div class="flex items-center me-1">
      <div class="flex items-center justify-center lg:w-(--sidebar-width) gap-1 shrink-0">
       ...
       <a class="mx-1" href="html/demo3.html">
        <img class="dark:hidden min-h-[24px]" src="{{ asset('assets/metronic9/media/app/mini-logo-primary.svg') }}"/>
        <img class="hidden dark:block min-h-[24px]" src="{{ asset('assets/metronic9/media/app/mini-logo-primary-dark.svg') }}"/>
       </a>
      </div>
        ...
        <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="hover">
         ...
         <div class="kt-menu-dropdown w-48 py-2">
          <div class="kt-menu-item">
           <a class="kt-menu-link" href="html/demo3/public-profile/profiles/default.html" tabindex="0">
          ...
          <div class="kt-menu-item active">
           <a class="kt-menu-link" href="html/demo3.html" tabindex="0">
            <span class="kt-menu-icon">
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link" href="html/demo3/network/get-started.html" tabindex="0">
            <span class="kt-menu-icon">
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link" href="html/demo3/authentication/get-started.html" tabindex="0">
            <span class="kt-menu-icon">
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link" href="html/demo3/store-client/home.html" tabindex="0">
            <span class="kt-menu-icon">
     ...
     <div class="flex items-center lg:gap-3.5">
      <!-- Action -->
      <a class="kt-btn kt-btn-primary mr-1 sm:me-0" href="html/demo3/account/home/get-started.html">
       Get Started
      </a>
      <!-- End of Action -->
      <div class="flex items-center gap-1.5">
       <!-- Search -->
       <button class="group kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full hover:[&_i]:text-primary" data-kt-modal-toggle="#search_modal">
        <i class="ki-filled ki-magnifier text-lg group-hover:text-primary">
        </i>
       </button>
       <!-- End of Search -->
       <!-- Chat -->
       <button class="kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full hover:[&_i]:text-primary" data-kt-drawer-toggle="#chat_drawer">
       ...
       <div class="hidden kt-drawer kt-drawer-end card flex-col max-w-[90%] w-[450px] top-5 bottom-5 end-5 rounded-xl border border-border" data-kt-drawer="true" data-kt-drawer-container="body" id="chat_drawer">
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5">
           <div class="flex items-center flex-wrap gap-2">
            <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-11">
             <img alt="" class="size-7" src="{{ asset('assets/metronic9/media/brand-logos/gitlab.svg') }}"/>
            </div>
           ...
           <div class="flex items-center gap-2.5">
            <div class="flex -space-x-2">
             <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{ asset('assets/metronic9/media/avatars/300-4.png') }}"/>
             </div>
             <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{ asset('assets/metronic9/media/avatars/300-1.png') }}"/>
             </div>
             <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{ asset('assets/metronic9/media/avatars/300-2.png') }}"/>
             </div>
             <div class="flex">
            ...
            <div class="kt-menu" data-kt-menu="true">
             <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
              ...
              <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
               <div class="kt-menu-item">
                <a class="kt-menu-link" href="html/demo3/account/members/teams.html">
                 <span class="kt-menu-icon">
                  <i class="ki-filled ki-users">
                  </i>
                 </span>
               ...
               <div class="kt-menu-item" data-kt-menu-item-offset="-15px, 0" data-kt-menu-item-placement="right-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
                ...
                <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]">
                 <div class="kt-menu-item">
                  <a class="kt-menu-link" href="html/demo3/account/members/import-members.html">
                   <span class="kt-menu-icon">
               ...
               <div class="kt-menu-item">
                <a class="kt-menu-link" href="html/demo3/account/security/privacy-settings.html">
                 <span class="kt-menu-icon">
        ...
        <div class="kt-scrollable-y-auto grow" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="230px">
         <div class="flex flex-col gap-5 py-5">
          <div class="flex items-end gap-3.5 px-5">
           <img alt="" class="rounded-full size-9" src="{{ asset('assets/metronic9/media/avatars/300-5.png') }}"/>
           ...
           <div class="relative shrink-0">
            <div class="kt-avatar size-9">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-2.png') }}">
              </img>
             </div>
          ...
          <div class="flex items-end gap-3.5 px-5">
           <img alt="" class="rounded-full size-9" src="{{ asset('assets/metronic9/media/avatars/300-4.png') }}"/>
           <div class="flex flex-col gap-1.5">
            <div class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
          ...
          <div class="flex items-end gap-3.5 px-5">
           <img alt="" class="rounded-full size-9" src="{{ asset('assets/metronic9/media/avatars/300-1.png') }}"/>
           <div class="flex flex-col gap-1.5">
            <div class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
        ...
        <div class="mb-2.5">
         <div class="flex grow gap-2 px-5 py-3.5 bg-accent/60 mb-2.5 border-y border-border" id="join_request">
          <div class="kt-avatar size-9">
           <div class="kt-avatar-image">
            <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-14.png') }}">
            </img>
           </div>
           <div class="kt-avatar-indicator -end-2 -bottom-2">
            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
         ...
         <div class="relative grow mx-5">
          <img alt="" class="rounded-full size-[30px] absolute start-0 top-2/4 -translate-y-2/4 ms-2.5" src="{{ asset('assets/metronic9/media/avatars/300-2.png') }}">
       ...
       <div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-10px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start">
        <button class="kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full hover:[&_i]:text-primary kt-dropdown-open:[&_i]:text-primary" data-kt-dropdown-toggle="true">
        ...
        <div class="kt-dropdown-menu p-0 w-screen max-w-[320px]" data-kt-dropdown-menu="true">
         ...
         <div class="flex flex-col kt-scrollable-y-auto max-h-[400px] divide-y divide-border">
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex items-center flex-wrap gap-2">
            <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
             <img alt="" class="size-6" src="{{ asset('assets/metronic9/media/brand-logos/jira.svg') }}">
             </img>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex items-center flex-wrap gap-2">
            <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
             <img alt="" class="size-6" src="{{ asset('assets/metronic9/media/brand-logos/inferno.svg') }}">
             </img>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex items-center flex-wrap gap-2">
            <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
             <img alt="" class="size-6" src="{{ asset('assets/metronic9/media/brand-logos/evernote.svg') }}"/>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
              Evernote
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex items-center flex-wrap gap-2">
            <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
             <img alt="" class="size-6" src="{{ asset('assets/metronic9/media/brand-logos/gitlab.svg') }}"/>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
              Gitlab
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex items-center flex-wrap gap-2">
            <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
             <img alt="" class="size-6" src="{{ asset('assets/metronic9/media/brand-logos/google-webdev.svg') }}"/>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
              Google webdev
         ...
         <div class="grid p-5 border-t border-t-border">
          <a class="kt-btn kt-btn-outline justify-center" href="html/demo3/account/integrations.html">
           Go to Apps
          </a>
         </div>
        </div>
       ...
       <!-- End of Apps -->
       <!-- Notifications -->
       <button class="kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full hover:[&_i]:text-primary" data-kt-drawer-toggle="#notifications_drawer">
       ...
       <div class="hidden kt-drawer kt-drawer-end card flex-col max-w-[90%] w-[450px] top-5 bottom-5 end-5 rounded-xl border border-border" data-kt-drawer="true" data-kt-drawer-container="body" id="notifications_drawer">
          ...
          <div class="grow flex flex-col gap-5 pt-3 pb-4 divider-y divider-border">
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-4.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-5.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_3">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-27.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-10.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <img class="h-5" src="{{ asset('assets/metronic9/media/file-types/pdf.svg') }}"/>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-11.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-background rounded-sm border border-border">
               <img class="h-5" src="{{ asset('assets/metronic9/media/file-types/figma.svg') }}"/>
              </div>
              <a class="hover:text-primary font-medium text-secondary-foreground text-xs me-1" href="#">
               Launcher-UIkit.fig
              </a>
         ...
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
           <div class="flex grow gap-2.5 px-5" id="notification_request_13">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-25.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-34.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center gap-1.5">
               <img class="h-6" src="{{ asset('assets/metronic9/media/file-types/xls.svg') }}"/>
           ...
           <div class="flex grow gap-2 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-29.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
            ...
            <div class="flex flex-col gap-3 grow">
             ...
             <div class="kt-card shadow-none p-3.5 gap-3.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-between flex-wrap gap-2.5">
               ...
               <div class="flex -space-x-2">
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-3.png') }}"/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-2.png') }}"/>
                </div>
               </div>
              </div>
              <div class="flex items-center gap-2.5">
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_3">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-30.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-24.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
         ...
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
           <div class="flex grow gap-2 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-15.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
            ...
            <div class="flex flex-col gap-3 grow" id="notification_request_10">
             ...
             <div class="kt-card shadow-none p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-between flex-wrap gap-2.5">
               ...
               <div class="flex -space-x-2">
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-4.png') }}"/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-1.png') }}"/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-2.png') }}"/>
                </div>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-6.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-12.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center gap-1.5">
               <img class="h-6" src="{{ asset('assets/metronic9/media/file-types/word.svg') }}"/>
               <div class="flex flex-col gap-0.5">
                <a class="hover:text-primary font-medium text-secondary-foreground text-xs" href="#">
                 Landing-page.docx
                </a>
             ...
             <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center gap-1.5">
               <img class="h-6" src="{{ asset('assets/metronic9/media/file-types/svg.svg') }}"/>
               <div class="flex flex-col gap-0.5">
                <a class="hover:text-primary font-medium text-secondary-foreground text-xs" href="#">
                 New-icon.svg
                </a>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-21.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
		...
		design is simply stunning! From layout to color, it's a work of art!
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_3">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-13.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
         ...
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-1.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
            ...
            <div class="flex flex-col gap-2.5 grow">
             ...
             <div class="flex items-center gap-2.5">
              <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
               <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24" style="background-image: url('{{ asset('assets/metronic9/media/images/600x600/6.jpg') }}')">
               </div>
              ...
              <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
               <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24" style="background-image: url('{{ asset('assets/metronic9/media/images/600x600/1.jpg') }}')">
               </div>
               <div class="px-2.5 pb-2">
                <a class="font-medium block text-secondary-foreground hover:text-primary text-xs leading-4 mb-0.5" href="#">
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_17">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-19.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
            ...
            <div class="flex flex-col gap-2.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-white rounded-sm border border-border">
               <img class="h-5" src="{{ asset('assets/metronic9/media/brand-logos/jira.svg') }}"/>
              </div>
              <a class="hover:text-primary font-medium text-secondary-foreground text-xs me-1" href="#">
               User-feedback.jira
              </a>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-17.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
		...
		article
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('assets/metronic9/media/avatars/300-9.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
      ...
      <div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-20px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
       <div class="cursor-pointer shrink-0" data-kt-dropdown-toggle="true">
        <img alt="" class="size-9 rounded-full border-2 border-input shrink-0" src="{{ asset('assets/metronic9/media/avatars/gray/5.png') }}"/>
       </div>
       <div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
        <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
         <div class="flex items-center gap-2">
          <img alt="" class="size-9 shrink-0 rounded-full border-2 border-green-500" src="{{ asset('assets/metronic9/media/avatars/300-2.png') }}"/>
          <div class="flex flex-col gap-1.5">
           <span class="text-sm text-foreground font-semibold leading-none">
            Cody Fisher
           </span>
           <a class="text-xs text-secondary-foreground hover:text-primary font-medium leading-none" href="html/demo3/account/home/get-started.html">
            c.fisher@gmail.com
           </a>
          </div>
         </div>
        ...
        <ul class="kt-dropdown-menu-sub">
         ...
         <li>
          <a class="kt-dropdown-menu-link" href="html/demo3/public-profile/profiles/default.html">
         ...
         <li>
          <a class="kt-dropdown-menu-link" href="html/demo3/account/home/user-profile.html">
           <i class="ki-filled ki-profile-circle">
           </i>
           My Profile
          </a>
         ...
         <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start" data-kt-dropdown-trigger="hover">
          ...
          <div class="kt-dropdown-menu w-[220px]" data-kt-dropdown-menu="true">
           <ul class="kt-dropdown-menu-sub">
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo3/account/home/get-started.html">
            ...
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo3/account/security/overview.html">
            ...
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo3/account/members/teams.html">
            ...
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo3/account/integrations.html">
         ...
         <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start" data-kt-dropdown-trigger="hover">
          <button class="kt-dropdown-menu-toggle py-1" data-kt-dropdown-toggle="true">
           ...
           <span class="ms-auto kt-badge kt-badge-stroke shrink-0">
            English
            <img alt="" class="inline-block size-3.5 rounded-full" src="{{ asset('assets/metronic9/media/flags/united-states.svg') }}"/>
           </span>
          </button>
           ...
           <ul class="kt-dropdown-menu-sub">
            <li class="active">
             <a class="kt-dropdown-menu-link" href="?dir=ltr">
              <span class="flex items-center gap-2">
               <img alt="" class="inline-block size-4 rounded-full" src="{{ asset('assets/metronic9/media/flags/united-states.svg') }}"/>
               <span class="kt-menu-title">
                English
               </span>
              </span>
            ...
            <li class="">
             <a class="kt-dropdown-menu-link" href="?dir=rtl">
              <span class="flex items-center gap-2">
               <img alt="" class="inline-block size-4 rounded-full" src="{{ asset('assets/metronic9/media/flags/saudi-arabia.svg') }}"/>
               <span class="kt-menu-title">
                Arabic(Saudi)
               </span>
              </span>
            ...
            <li class="">
             <a class="kt-dropdown-menu-link" href="?dir=ltr">
              <span class="flex items-center gap-2">
               <img alt="" class="inline-block size-4 rounded-full" src="{{ asset('assets/metronic9/media/flags/spain.svg') }}"/>
               <span class="kt-menu-title">
                Spanish
               </span>
              </span>
            ...
            <li class="">
             <a class="kt-dropdown-menu-link" href="?dir=ltr">
              <span class="flex items-center gap-2">
               <img alt="" class="inline-block size-4 rounded-full" src="{{ asset('assets/metronic9/media/flags/germany.svg') }}"/>
               <span class="kt-menu-title">
                German
               </span>
              </span>
            ...
            <li class="">
             <a class="kt-dropdown-menu-link" href="?dir=ltr">
              <span class="flex items-center gap-2">
               <img alt="" class="inline-block size-4 rounded-full" src="{{ asset('assets/metronic9/media/flags/japan.svg') }}"/>
               <span class="kt-menu-title">
                Japanese
               </span>
              </span>
        ...
        <div class="px-2.5 pt-1.5 mb-2.5 flex flex-col gap-3.5">
         ...
         <a class="kt-btn kt-btn-outline justify-center w-full" href="html/demo3/authentication/classic/sign-in.html">
          Log out
         </a>
        </div>
       </div>
    ...
    <div class="fixed w-(--sidebar-width) lg:top-(--header-height) top-0 bottom-0 z-20 hidden lg:flex flex-col items-stretch shrink-0 group py-3 lg:py-0 [--kt-drawer-enable:true] lg:[--kt-drawer-enable:false]" data-kt-drawer="true" data-kt-drawer-class="kt-drawer kt-drawer-start top-0 bottom-0" id="sidebar">
     <div class="flex grow shrink-0" id="sidebar_content">
      <div class="kt-scrollable-y-auto grow gap-2.5 shrink-0 flex items-center flex-col max-h-[calc(100dvh-10px))] lg:max-h-[calc(100dvh-70px))]">
       @include('theme.partials.metronic9-phc-sidebar')
      </div>
     </div>
    </div>
    <!-- End of Sidebar -->
       ...
       <div class="grid items-stretch">
        <div class="kt-scrollable-x-auto flex items-stretch">
         <div class="kt-menu gap-5 lg:gap-7.5" data-kt-menu="true">
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
           <div class="kt-menu-link gap-1.5" tabindex="0">
            <span class="kt-menu-title text-nowrap text-sm text-foreground kt-menu-item-active:text-mono kt-menu-item-active:font-medium kt-menu-item-here:text-mono kt-menu-item-here:font-medium kt-menu-item-show:text-mono kt-menu-link-hover:text-mono">
             Account Home
            </span>
            <span class="kt-menu-arrow">
           ...
           <div class="kt-menu-dropdown kt-menu-default py-2 min-w-[200px]">
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/home/get-started.html" tabindex="0">
              <span class="kt-menu-title">
               Get Started
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/home/user-profile.html" tabindex="0">
              <span class="kt-menu-title">
               User Profile
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/home/company-profile.html" tabindex="0">
              <span class="kt-menu-title">
               Company Profile
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/home/settings-sidebar.html" tabindex="0">
              <span class="kt-menu-title">
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/home/settings-enterprise.html" tabindex="0">
              <span class="kt-menu-title">
               Settings - Enterprise
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/home/settings-plain.html" tabindex="0">
              <span class="kt-menu-title">
               Settings - Plain
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/home/settings-modal.html" tabindex="0">
              <span class="kt-menu-title">
               Settings - Modal
              </span>
             </a>
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
           ...
           <div class="kt-menu-dropdown kt-menu-default py-2 min-w-[200px]">
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/billing/basic.html" tabindex="0">
              <span class="kt-menu-title">
               Billing - Basic
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/billing/enterprise.html" tabindex="0">
              <span class="kt-menu-title">
               Billing - Enterprise
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/billing/plans.html" tabindex="0">
              <span class="kt-menu-title">
               Plans
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/billing/history.html" tabindex="0">
              <span class="kt-menu-title">
               Billing History
              </span>
             </a>
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
           ...
           <div class="kt-menu-dropdown kt-menu-default py-2 min-w-[200px]">
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/security/get-started.html" tabindex="0">
              <span class="kt-menu-title">
               Get Started
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/security/overview.html" tabindex="0">
              <span class="kt-menu-title">
               Security Overview
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/security/allowed-ip-addresses.html" tabindex="0">
              <span class="kt-menu-title">
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/security/privacy-settings.html" tabindex="0">
              <span class="kt-menu-title">
               Privacy Settings
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/security/device-management.html" tabindex="0">
              <span class="kt-menu-title">
               Device Management
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/security/backup-and-recovery.html" tabindex="0">
              <span class="kt-menu-title">
               Backup & Recovery
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/security/current-sessions.html" tabindex="0">
              <span class="kt-menu-title">
               Current Sessions
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/security/security-log.html" tabindex="0">
              <span class="kt-menu-title">
               Security Log
              </span>
             </a>
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
           ...
           <div class="kt-menu-dropdown kt-menu-default py-2 min-w-[200px]">
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/members/team-starter.html" tabindex="0">
              <span class="kt-menu-title">
               Teams Starter
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/members/teams.html" tabindex="0">
              <span class="kt-menu-title">
               Teams
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/members/team-info.html" tabindex="0">
              <span class="kt-menu-title">
               Team Info
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/members/members-starter.html" tabindex="0">
              <span class="kt-menu-title">
               Members Starter
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/members/team-members.html" tabindex="0">
              <span class="kt-menu-title">
               Team Members
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/members/team-members-datatable.html" tabindex="0">
              <span class="kt-menu-title">
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/members/import-members.html" tabindex="0">
              <span class="kt-menu-title">
               Import Members
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/members/roles.html" tabindex="0">
              <span class="kt-menu-title">
               Roles
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/members/permissions-toggle.html" tabindex="0">
              <span class="kt-menu-title">
               Permissions - Toggler
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/members/permissions-check.html" tabindex="0">
              <span class="kt-menu-title">
               Permissions - Check
              </span>
             </a>
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono">
           <a class="kt-menu-link gap-2.5" href="html/demo3/account/integrations.html" tabindex="0">
            <span class="kt-menu-title text-nowrap text-sm text-foreground kt-menu-item-active:text-mono kt-menu-item-active:font-medium kt-menu-item-here:text-mono kt-menu-item-here:font-medium kt-menu-item-show:text-mono kt-menu-link-hover:text-mono">
             Integrations
            </span>
           </a>
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono">
           <a class="kt-menu-link gap-2.5" href="html/demo3/account/notifications.html" tabindex="0">
            <span class="kt-menu-title text-nowrap text-sm text-foreground kt-menu-item-active:text-mono kt-menu-item-active:font-medium kt-menu-item-here:text-mono kt-menu-item-here:font-medium kt-menu-item-show:text-mono kt-menu-link-hover:text-mono">
             Notifications
            </span>
           </a>
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono">
           <a class="kt-menu-link gap-2.5" href="html/demo3/account/api-keys.html" tabindex="0">
            <span class="kt-menu-title text-nowrap text-sm text-foreground kt-menu-item-active:text-mono kt-menu-item-active:font-medium kt-menu-item-here:text-mono kt-menu-item-here:font-medium kt-menu-item-show:text-mono kt-menu-link-hover:text-mono">
             API Keys
            </span>
           </a>
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
           ...
           <div class="kt-menu-dropdown kt-menu-default py-2 min-w-[200px]">
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/appearance.html" tabindex="0">
              <span class="kt-menu-title">
               Appearance
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/invite-a-friend.html" tabindex="0">
              <span class="kt-menu-title">
               Invite a Friend
              </span>
             </a>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="html/demo3/account/activity.html" tabindex="0">
              <span class="kt-menu-title">
               Activity
              </span>
             </a>
           ...
           <div class="kt-card h-full">
            <div class="kt-card-content flex flex-col place-content-center gap-5">
             <div class="flex justify-center">
              <img alt="image" class="dark:hidden max-h-[180px]" src="{{ asset('assets/metronic9/media/illustrations/32.svg') }}"/>
              <img alt="image" class="light:hidden max-h-[180px]" src="{{ asset('assets/metronic9/media/illustrations/32-dark.svg') }}"/>
             </div>
                 ...
                 <tbody>
                  ...
                  <tr>
                   ...
                   <td>
                    <div class="flex -space-x-2">
                     <div class="flex">
                      <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{ asset('assets/metronic9/media/avatars/300-24.png') }}"/>
                     </div>
                     <div class="flex">
                      <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{ asset('assets/metronic9/media/avatars/300-7.png') }}"/>
                     </div>
                    </div>
                   </td>
                  </tr>
            ...
            <div class="kt-card-content flex flex-col gap-5">
             ...
             <div class="flex flex-col gap-5">
              <div class="flex items-center justify-between gap-2.5">
               <div class="flex items-center gap-2.5">
                <div class="">
                 <img class="h-9 rounded-full" src="{{ asset('assets/metronic9/media/avatars/gray/1.png') }}"/>
                </div>
                <div class="flex flex-col gap-0.5">
              ...
              <div class="flex items-center justify-between gap-2.5">
               <div class="flex items-center gap-2.5">
                <div class="">
                 <img class="h-9 rounded-full" src="{{ asset('assets/metronic9/media/avatars/gray/2.png') }}"/>
                </div>
                <div class="flex flex-col gap-0.5">
                 <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary" href="html/demo3/public-profile/teams.html">
                  Tyler Hero
              ...
              <div class="flex items-center justify-between gap-2.5">
               <div class="flex items-center gap-2.5">
                <div class="">
                 <img class="h-9 rounded-full" src="{{ asset('assets/metronic9/media/avatars/gray/3.png') }}"/>
                </div>
                <div class="flex flex-col gap-0.5">
                 <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary" href="html/demo3/public-profile/teams.html">
                  Arlene McCoy
             ...
             <div class="grid gap-5">
              <div class="flex items-center justify-between flex-wrap border border-border rounded-xl gap-2 p-3.5">
               <div class="flex items-center flex-wrap gap-3.5">
                <img alt="" class="size-8 shrink-0" src="{{ asset('assets/metronic9/media/brand-logos/google-webdev.svg') }}"/>
                <div class="flex flex-col">
                 <div class="flex items-center gap-1.5">
                  <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                   Google web.dev
                  </a>
                  <a class="text-sm font-medium text-muted-foreground hover:text-primary" href="#">
               ...
               <div class="flex items-center gap-3">
                ...
                <div class="kt-btn kt-btn-ghost kt-btn-icon">
                 <i class="ki-filled ki-setting-2">
                 </i>
                </div>
               </div>
              ...
              <div class="flex items-center justify-between flex-wrap border border-border rounded-xl gap-2 p-3.5">
               <div class="flex items-center flex-wrap gap-3.5">
                <img alt="" class="size-8 shrink-0" src="{{ asset('assets/metronic9/media/brand-logos/evernote.svg') }}"/>
                <div class="flex flex-col">
                 <div class="flex items-center gap-1.5">
                  <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                   Evernote
              ...
              <div class="flex items-center justify-between flex-wrap border border-border rounded-xl gap-2 p-3.5">
               <div class="flex items-center flex-wrap gap-3.5">
                <img alt="" class="size-8 shrink-0" src="{{ asset('assets/metronic9/media/brand-logos/inferno.svg') }}"/>
                <div class="flex flex-col">
                 <div class="flex items-center gap-1.5">
                  <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                   Inferno
     ...
     <div class="kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="300px">
         ...
         <div class="kt-menu kt-menu-default px-0.5 flex-col">
           ...
           <div class="kt-menu-link flex items-center jistify-between gap-2">
            <div class="flex items-center grow gap-2">
             <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
              <img alt="" class="size-6 shrink-0" src="{{ asset('assets/metronic9/media/brand-logos/jira.svg') }}"/>
             </div>
             <div class="flex flex-col gap-0.5">
              <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
               Jira
          ...
          <div class="kt-menu-item">
           <div class="kt-menu-link flex items-center jistify-between gap-2">
            <div class="flex items-center grow gap-2">
             <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
              <img alt="" class="size-6 shrink-0" src="{{ asset('assets/metronic9/media/brand-logos/inferno.svg') }}"/>
             </div>
             <div class="flex flex-col gap-0.5">
              <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
               Inferno
            ...
            <div class="flex justify-end shrink-0">
             <div class="flex -space-x-2">
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-14.png') }}"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-12.png') }}"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-9.png') }}"/>
              </div>
             </div>
            </div>
           </div>
          ...
          <div class="grid gap-1">
           <div class="kt-menu-item">
            <div class="kt-menu-link flex justify-between gap-2">
             <div class="flex items-center gap-2.5">
              <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('assets/metronic9/media/avatars/300-3.png') }}"/>
              <div class="flex flex-col">
           ...
           <div class="kt-menu-item">
            <div class="kt-menu-link flex justify-between gap-2">
             <div class="flex items-center gap-2.5">
              <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('assets/metronic9/media/avatars/300-1.png') }}"/>
              <div class="flex flex-col">
               <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
                Esther Howard
               </a>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('assets/metronic9/media/brand-logos/evernote.svg') }}"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Evernote
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-6.png') }}"/>
            </div>
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-3.png') }}"/>
            </div>
            ...
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-8.png') }}"/>
            </div>
           </div>
          </div>
         </div>
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('assets/metronic9/media/brand-logos/gitlab.svg') }}"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Gitlab
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-18.png') }}"/>
            </div>
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-17.png') }}"/>
            </div>
           </div>
          </div>
         </div>
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('assets/metronic9/media/brand-logos/google-webdev.svg') }}"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Google webdev
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            ...
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-20.png') }}"/>
            </div>
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('assets/metronic9/media/avatars/300-21.png') }}"/>
            </div>
           </div>
          </div>
         </div>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        <div class="grid gap-1">
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('assets/metronic9/media/avatars/300-11.png') }}"/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              Jacob Jones
             </a>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('assets/metronic9/media/avatars/300-5.png') }}"/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              TLeslie Alexander
             </a>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('assets/metronic9/media/avatars/300-2.png') }}"/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              Cody Fisher
             </a>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        <div class="grid">
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('assets/metronic9/media/file-types/pdf.svg') }}"/>
            <div class="flex flex-col">
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('assets/metronic9/media/file-types/doc.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              Report-v1.docx
             </span>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('assets/metronic9/media/file-types/javascript.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              Framework-App.js
             </span>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('assets/metronic9/media/file-types/ai.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              Framework-App.js
             </span>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('assets/metronic9/media/file-types/php.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              appController.js
             </span>
      ...
      <div class="hidden" id="search_modal_empty">
       <div class="flex flex-col text-center py-9 gap-5">
        <div class="flex justify-center">
         <img alt="image" class="dark:hidden max-h-[113px]" src="{{ asset('assets/metronic9/media/illustrations/33.svg') }}"/>
         <img alt="image" class="light:hidden max-h-[113px]" src="{{ asset('assets/metronic9/media/illustrations/33-dark.svg') }}"/>
        </div>
        <div class="flex flex-col gap-1.5">
     ...
     <div class="p-5">
      <div class="grid place-items-center gap-1">
       <div class="flex justify-center items-center rounded-full">
        <img class="rounded-full max-h-[55px] max-w-full" src="{{ asset('assets/metronic9/media/avatars/300-1.png') }}"/>
       </div>
  ...
  <!-- End of Page -->
  <div class="fixed bottom-5 start-5 z-[100] flex items-center gap-2 rounded-lg border border-border bg-background/95 p-2 shadow-lg backdrop-blur">
   <a href="{{ app_route('dashboard') }}" class="kt-btn kt-btn-light kt-btn-sm">
    العودة للنظام
   </a>
   <form method="POST" action="{{ route('theme.metronic9.update') }}" class="m-0">
    @csrf
  ...
  <!-- Scripts -->
  <script src="{{ asset('assets/metronic9/js/core.bundle.js') }}">
  </script>
  <script src="{{ asset('assets/metronic9/vendors/ktui/ktui.min.js') }}">
  </script>
  <script src="{{ asset('assets/metronic9/vendors/apexcharts/apexcharts.min.js') }}">
  </script>
  <script src="{{ asset('assets/metronic9/js/widgets/general.js') }}">
  </script>
  <!-- End of Scripts -->
 </body>
</html>
