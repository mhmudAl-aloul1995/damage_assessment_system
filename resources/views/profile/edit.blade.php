            ...
            <div class="d-flex flex-wrap flex-sm-nowrap">
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                        <img src="{{ $user->avatar ? asset('storage/' . $user->avatar) : asset('assets/media/avatars/300-1.jpg') }}"
                            alt="image" />
                        <div
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        <div class="d-flex flex-column min-w-0">
                            <div class="d-flex align-items-center mb-2 min-w-0">
                                <a href="#"
                                    class="text-gray-900 text-hover-primary fw-bold me-1 text-truncate fs-4 fs-md-2"
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                <li class="nav-item mt-2">
                    <a onclick="$(this).addClass('active');$('.setting').removeClass('active'); $('#kt_profile_details_view').fadeIn();$('#kt_profile_details_edit').fadeOut();"
                        class="public nav-link text-active-primary ms-0 me-10 py-5 active"
                        href="javascript:void(0)">عام</a>
                </li>

                <li class="nav-item mt-2">
                    <a onclick="$(this).addClass('active');$('.public').removeClass('active'); $('#kt_profile_details_view').fadeOut();$('#kt_profile_details_edit').fadeIn();"
                        class="setting nav-link text-active-primary ms-0 me-10 py-5"
                        href="javascript:void(0)">الإعدادات</a>
                </li>
            </ul>
        </div>
    </div>
