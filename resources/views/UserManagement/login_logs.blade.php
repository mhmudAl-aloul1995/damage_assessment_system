        ...
        <div class="card mb-5">
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <button class="btn btn-light btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#loginLogsFilters">
            ...
            <div class="card-body pt-0">
                ...
                <div class="collapse show mb-5" id="loginLogsFilters">
                    <form id="filter_form" class="row g-4 align-items-end">
                        ...
                        <div class="col-md-3">
                            ...
                            <select id="filter_user_id" class="form-select form-select-sm" data-control="select2" data-placeholder="All Users">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" id="filter_ip_address" class="form-control form-control-sm" placeholder="IP">
                        </div>

                        <div class="col-md-2">
                            <label class="form-label">From Date</label>
                            <input type="text" id="filter_from_date" class="form-control form-control-sm flatpickr-input" data-date-format="yyyy-mm-dd">
                        </div>

                        <div class="col-md-2">
                            <label class="form-label">To Date</label>
                            <input type="text" id="filter_to_date" class="form-control form-control-sm flatpickr-input" data-date-format="yyyy-mm-dd">
                        </div>
                ...
                <div class="table-responsive">
                    <table id="kt_datatable_login_logs" class="table table-row-bordered table-row-gray-300 align-middle gy-4">
                        <thead>
