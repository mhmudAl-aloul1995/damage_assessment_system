...
<html lang="{{ app()->getLocale() }}" direction="{{ $direction }}" dir="{{ $direction }}"
...
<style>
	@font-face {
		...
		src: url('{{ asset("assets/DroidArabicKufi.eot") }}');
		src:
			url('{{ asset("assets/DroidArabicKufi.eot?#iefix") }}') format('embedded-opentype'),
			url('{{ asset("assets/DroidArabicKufi.woff") }}') format('woff'),
			url('{{ asset("assets/DroidArabicKufi.ttf") }}') format('truetype');
			...
			<div id="kt_app_header" class="app-header" data-kt-sticky="true"
				...
				<div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
					...
					<div class="d-flex align-items-center d-lg-none ms-n3 me-1 me-md-2"
						title="{{ __('ui.search.show_sidebar') }}">
								...
								<div data-kt-search-element="content"
									...
									<div data-kt-search-element="wrapper">
										...
										<form data-kt-search-element="form" class="w-100 position-relative mb-3"
											...
											<input type="text" id="global-search-input"
												...
												value="" placeholder="{{ __('ui.search.placeholder') }}"
									...
									<form data-kt-search-element="preferences" class="pt-1 d-none">
										...
										<div class="d-flex justify-content-end pt-7">
											...
											<button type="submit"
												class="btn btn-sm fw-bold btn-primary">{{ __('ui.buttons.save') }}</button>
										</div>
										<!--end::Actions-->
									</form>
									<!--end::Preferences-->
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-350px"
								...
								<div class="menu-item px-5">
									<a href="{{ route('profile.edit') }}"
										class="menu-link px-5">{{ __('ui.nav.profile') }}</a>
								</div>
							...
							<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
								...
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
									...
									<li class="breadcrumb-item text-muted">
										<a href="{{url('')}}"
											class="text-muted text-hover-primary">{{ __('ui.nav.home') }}</a>
									</li>
									<!--end::Item-->
									<!--begin::Item-->
