...
<head>
	...
	<link href="{{url('')}}/assets/plugins/custom/fullcalendar/fullcalendar.bundle.rtl.css" rel="stylesheet"
		type="text/css" />
	<link href="{{url('')}}/assets/plugins/custom/datatables/datatables.bundle.rtl.css" rel="stylesheet"
		type="text/css" />
					...
					<div class="app-navbar flex-shrink-0">
						...
						<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
							...
							<div class="cursor-pointer symbol symbol-35px"
								...
								data-kt-menu-placement="bottom-end">
								<img src="{{ Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : asset('assets/media/avatars/blank.png') }}" class="rounded-3"
									alt="user" />
							</div>
		...
		$(document).ready(function () {
			...
			searchInput.on('keyup', function () {
				...
				timeout = setTimeout(function () {
					...
					$.ajax({
						url: "{{ url('search-buildings') }}", // Your Laravel Route
						method: 'GET',
						data: { search: query },
