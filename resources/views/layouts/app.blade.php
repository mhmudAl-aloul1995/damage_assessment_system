...
<html lang="{{ app()->getLocale() }}" direction="{{ $direction }}" dir="{{ $direction }}" style="direction: {{ $direction }}">
<!--begin::Head-->
...
<head>
	...
	<link href="{{url('')}}/assets/plugins/custom/fullcalendar/fullcalendar.bundle{{ $suffix }}.css" rel="stylesheet"
		type="text/css" />
	<link href="{{url('')}}/assets/plugins/custom/datatables/datatables.bundle{{ $suffix }}.css" rel="stylesheet"
		type="text/css" />
...
<style>
	...
	td,
	.text-end {
		text-align: {{ $isRtl ? 'center' : 'inherit' }} !important;
	}
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
		...
		<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
			...
			<div id="kt_app_header" class="app-header" data-kt-sticky="true"
				...
				<div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
					...
					<div class="d-flex align-items-center d-lg-none ms-n3 me-1 me-md-2" title="{{ __('ui.search.show_sidebar') }}">
					...
					<div class="app-navbar flex-shrink-0">
									...
									<div data-kt-search-element="wrapper">
										...
										<form data-kt-search-element="form" class="w-100 position-relative mb-3"
											...
											<input type="text"
												...
												value="" placeholder="{{ __('ui.search.placeholder') }}" data-kt-search-element="input" />
											<!--end::Input-->
											<!--begin::Spinner-->
											<span
											...
											<div class="position-absolute top-50 end-0 translate-middle-y"
												...
												<div data-kt-search-element="preferences-show"
													...
													data-bs-toggle="tooltip" title="{{ __('ui.search.preferences') }}">
												...
												<div data-kt-search-element="advanced-options-form-show"
													...
													data-bs-toggle="tooltip" title="{{ __('ui.search.advanced') }}">
										...
										<div data-kt-search-element="results" class="d-none">
											...
											<div class="scroll-y mh-200px mh-lg-350px">
												...
												<h3 class="fs-5 text-muted m-0 pb-5"
													data-kt-search-element="category-title">{{ __('ui.search.users') }}</h3>
												<!--end::Category title-->
												<!--begin::Item-->
												<a href="#"
												...
												<h3 class="fs-5 text-muted m-0 pt-5 pb-5"
													data-kt-search-element="category-title">{{ __('ui.search.customers') }}</h3>
												<!--end::Category title-->
												<!--begin::Item-->
												<a href="#"
													class="d-flex text-dark text-hover-primary align-items-center mb-5">
												...
												<!--begin::Category title-->
												<h3 class="fs-5 text-muted m-0 pt-5 pb-5"
													data-kt-search-element="category-title">{{ __('ui.search.projects') }}</h3>
												<!--end::Category title-->
												<!--begin::Item-->
												<a href="#"
													class="d-flex text-dark text-hover-primary align-items-center mb-5">
										...
										<div class="mb-5">
											...
											<div class="nav-group nav-group-fluid">
												...
												<label>
													...
													<span
														class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">{{ __('ui.search.users') }}</span>
												</label>
												<!--end::Option-->
												<!--begin::Option-->
												<label>
												...
												<label>
													<input type="radio" class="btn-check" name="type"
														value="projects" />
													<span
														class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">{{ __('ui.search.projects') }}</span>
												</label>
												<!--end::Option-->
											</div>
											<!--end::Radio group-->
									...
									<form data-kt-search-element="preferences" class="pt-1 d-none">
										...
										<div class="pb-4 border-bottom">
											<label
												...
												<span
													class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">{{ __('ui.search.projects') }}</span>
										...
										<div class="py-4 border-bottom">
											<label
												class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
												<span
													class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">{{ __('ui.search.users') }}</span>
												<input class="form-check-input" type="checkbox" value="1" />
											</label>
										</div>
										<!--end::Input group-->
										...
										<div class="d-flex justify-content-end pt-7">
											<button type="reset"
												class="btn btn-sm btn-light fw-bold btn-active-light-primary me-2"
												data-kt-search-element="preferences-dismiss">{{ __('ui.buttons.cancel') }}</button>
											<button type="submit" class="btn btn-sm fw-bold btn-primary">{{ __('ui.buttons.save') }}</button>
										</div>
										<!--end::Actions-->
									</form>
									<!--end::Preferences-->
						...
						<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
							...
							<div class="cursor-pointer symbol symbol-35px"
								...
								data-kt-menu-placement="bottom-end">
								<img src="{{ Auth::user()->avatar ? asset('storage/app/public/avatars' . Auth::user()->avatar) : asset('assets/media/avatars/blank.png') }}"
								...
								<div class="menu-item px-3">
									<div class="menu-content d-flex align-items-start px-3 py-4 w-100">
										...
										<div class="symbol symbol-50px ms-4 flex-shrink-0">
											<img alt="Avatar"
												src="{{ Auth::user()->avatar ? asset('storage/app/public/avatars'. Auth::user()->avatar) : asset('assets/media/avatars/blank.png') }}"
						...
						<div class="app-navbar-item d-lg-none ms-2 me-n2" title="{{ __('ui.search.show_header') }}">
							...
							<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
								...
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
									...
									<li class="breadcrumb-item text-muted">
										<a href="{{url('')}}" class="text-muted text-hover-primary">{{ __('ui.nav.home') }}</a>
									</li>
									<!--end::Item-->
									<!--begin::Item-->
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-muted">@yield('pageName')</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
							</div>
	...
	<script>
		...
		$(document).ready(function () {
			...
			const quickSearchLinks = @json($quickSearchLinks);
			const noResultsTemplate = @json(__('ui.search.no_results', ['query' => '__QUERY__']));
			...
			const renderQuickLinks = () => {
				let html = `
					<div class="d-flex flex-stack fw-semibold mb-4">
						<span class="text-muted fs-6 me-2">${escapeHtml(@json(__('ui.search.quick_access')))}</span>
					</div>
					<div class="text-muted fs-7 mb-5">${escapeHtml(@json(__('ui.search.start_typing')))}</div>
					<div class="scroll-y mh-200px mh-lg-325px">
				`;
		...
		function showModal(formName, id) {
			...
			if (id == null) {
				...
				//  $('#kt_modal_' + formName + '_form').attr('action', "{{url('')}}/" + formName);
