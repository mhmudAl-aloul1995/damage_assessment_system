            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                ...
                <div class="d-flex flex-center flex-lg-start flex-column">
                    ...
                    <a href="../../demo1/dist/index.html" class="mb-7">
                        <img style="max-width: 400px; height: auto;" class="h-100px" alt="Logo" src="{{ url('') }}/assets/media/logos/LogoGaza2.jpeg" />
                    </a>250
                    <!--end::Logo-->
                    <!--begin::Title-->
            ...
            <div
                ...
                <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <form class="form w-100" data-kt-redirect-url="{{ url('/') }}" novalidate="novalidate" id="kt_sign_in_form" method="POST"
                            action="{{ route('login') }}">
                            @csrf
