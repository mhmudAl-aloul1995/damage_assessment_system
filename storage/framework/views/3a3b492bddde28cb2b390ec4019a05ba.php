<?php $__env->startSection('title', __('ui.permissions.title')); ?>
<?php $__env->startSection('pageName', __('ui.permissions.title')); ?>
    ...
    <div class="card-header mt-6">
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1 me-5">
                ...
                <input type="text" id="permission_search" class="form-control form-control-solid w-250px ps-13"
                    placeholder="<?php echo e(__('ui.permissions.search_placeholder')); ?>" />
            </div>
        </div>
        ...
        <div class="card-toolbar">
            <button type="button" class="btn btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_permission">
                ...
                <?php echo e(__('ui.permissions.add_button')); ?>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
            <thead>
                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    <th><?php echo e(__('ui.permissions.name')); ?></th>
                    <th><?php echo e(__('ui.permissions.assigned_to')); ?></th>
                    <th><?php echo e(__('ui.permissions.created_at')); ?></th>
                    <th class="text-end"><?php echo e(__('ui.permissions.actions')); ?></th>
                </tr>
            </thead>
            <tbody></tbody>
        </table>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bold"><?php echo e(__('ui.permissions.add_title')); ?></h2>
                ...
                <form id="kt_modal_add_permission_form" class="form">
                    ...
                    <div class="fv-row mb-7">
                        <label class="fs-6 fw-semibold form-label mb-2">
                            <span class="required"><?php echo e(__('ui.permissions.name_label')); ?></span>
                        </label>

                        <input class="form-control form-control-solid" placeholder="<?php echo e(__('ui.permissions.name_placeholder')); ?>" name="name" />
                    </div>

                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" data-bs-dismiss="modal"><?php echo e(__('ui.buttons.discard')); ?></button>
                        <button type="submit" class="btn btn-primary" id="add_permission_submit_btn">
                            <span class="indicator-label"><?php echo e(__('ui.buttons.submit')); ?></span>
...
<div class="modal fade" id="kt_modal_update_permission" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bold"><?php echo e(__('ui.permissions.update_title')); ?></h2>
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal">
                    <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                </div>
            </div>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <div class="fw-semibold fs-6 text-gray-700">
                        <strong class="me-1"><?php echo e(__('ui.permissions.warning_title')); ?></strong>
                        <?php echo e(__('ui.permissions.warning_text')); ?>
                ...
                <form id="kt_modal_update_permission_form" class="form">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <input class="form-control form-control-solid" placeholder="<?php echo e(__('ui.permissions.name_placeholder')); ?>" name="name" id="edit_permission_name" />
                    </div>
...
<script>
    ...
    const permissionTranslations = {
        ...
        deleteConfirm: <?php echo json_encode(__('ui.permissions.delete_confirm', ['name' => '__NAME__']), 512) ?>,
        yesDelete: <?php echo json_encode(__('ui.buttons.yes_delete'), 15, 512) ?>,
        cancel: <?php echo json_encode(__('ui.buttons.cancel'), 15, 512) ?>,
    ...
    $(document).ready(function () {
        permissionsTable = $('#kt_permissions_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('permissions.data')); ?>",
            info: false,
            pageLength: 10,
            lengthChange: false,
            order: [[0, 'asc']],
        ...
        $(document).on('click', '.btn-edit-permission', function () {
            ...
            $.ajax({
                url: "<?php echo e(url('user-management/permissions')); ?>/" + id + "/edit",
                type: "GET",
                success: function (response) {
        ...
        $('#kt_modal_update_permission_form').on('submit', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(url('user-management/permissions')); ?>/" + id,
                type: "POST",
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\myProjects\phc\resources\views/UserManagement/permissions.blade.php ENDPATH**/ ?>