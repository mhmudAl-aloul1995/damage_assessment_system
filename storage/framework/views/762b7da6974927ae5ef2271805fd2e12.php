<?php $__env->startSection('title', 'Telegram Integrations'); ?>
<?php $__env->startSection('pageName', 'Telegram Integrations'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-md-3">
            <div class="card card-flush h-100 border border-gray-200">
                <div class="card-body">
                    ...
                    <div class="fs-2hx fw-bold text-primary"><?php echo e($counts['total']); ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card card-flush h-100 border border-gray-200">
                <div class="card-body">
                    ...
                    <div class="fs-2hx fw-bold text-success"><?php echo e($counts['connected']); ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card card-flush h-100 border border-gray-200">
                <div class="card-body">
                    ...
                    <div class="fs-2hx fw-bold text-info"><?php echo e($counts['pending']); ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card card-flush h-100 border border-gray-200">
                <div class="card-body">
                    ...
                    <div class="fs-2hx fw-bold text-danger"><?php echo e($counts['failed']); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="alert alert-info d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-5">
        ...
        <div class="text-muted fs-8">
            Webhook endpoint: <code><?php echo e(route('telegram.webhook', ['secret' => config('services.telegram.webhook_secret', 'set-secret')])); ?></code>
        </div>
    </div>
    ...
    <div class="card card-flush shadow-sm">
        <div class="card-header pt-6 d-flex justify-content-between align-items-center">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canManageTelegramIntegrations): ?>
        ...
        <div class="modal fade" id="telegram_integration_modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered mw-700px">
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo e(route('telegram-integrations.store')); ?>">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <select name="user_id" class="form-select form-select-solid">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                            <option value="<?php echo e($user->id); ?>">
                                                <?php echo e($user->name); ?><?php echo e($user->username_arcgis ? ' - '.$user->username_arcgis : ''); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            $('#telegram_integrations_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('telegram-integrations.data')); ?>',
                order: [[8, 'desc']],
                columns: [
                    { data: 'name', name: 'name' },
                    { data: 'type', name: 'type' },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\myProjects\phc\resources\views/Committee/TelegramIntegrations/index.blade.php ENDPATH**/ ?>