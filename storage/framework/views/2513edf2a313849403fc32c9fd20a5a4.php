            ...
            <div class="card-body">
                <div class="row g-5">
                    <div class="col-md-3">
                        ...
                        <input type="text" id="filter_building_name" class="form-control form-control-solid" placeholder="اسم المبنى" />
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" id="filter_area" class="form-control form-control-solid" placeholder="المنطقة أو الحي" />
                    </div>
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_datatable_audits .form-check-input" value="1" />
                                </div>
                            </th>
                            <th>Building Name</th>
                            <th>Engineer</th>
