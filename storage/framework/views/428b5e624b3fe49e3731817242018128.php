<?php $__env->startSection('title', __('ui.buildings_page.title')); ?>
<?php $__env->startSection('pageName', __('ui.buildings_page.title')); ?>
	...
	<div class="card mb-12">
		<div class="card shadow-sm">
			<div class="card-header collapsible cursor-pointer rotate" data-bs-toggle="collapse"
				...
				<h3 class="card-title"><?php echo e(__('ui.buildings_page.filter')); ?></h3>
				...
				<div id="kt_building_filter" class="collapse show">
					...
					<div class="card-body">
						<div class="row g-9 mb-8">
							...
							<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $filterName; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
								...
								<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Schema::hasColumn('buildings', $value)): ?>
							...
							<div class="col-md-3 fv-row">
								...
								<label class="fs-6 fw-semibold mb-2"><?php echo e(__('ui.buildings_page.neighborhood')); ?></label>
								<select data-allow-clear="true" class="form-select form-select-solid" data-control="select2"
									data-hide-search="false" data-placeholder="<?php echo e(__('ui.buildings_page.neighborhood')); ?>" name="neighborhood">
					...
					<div class="card-footer">
						<div class="text-center">
							<button type="reset" class="btn btn-light me-3" data-kt-Buildings-filter-action="reset"><?php echo e(__('ui.buildings_page.reset')); ?></button>
							<button onclick="$('#kt_table_Building').DataTable().ajax.reload()" type="submit"
								...
								<span class="indicator-label"><?php echo e(__('ui.buildings_page.search')); ?></span>
								<span class="indicator-progress"><?php echo e(__('ui.buildings_page.please_wait')); ?>
				...
				<div class="card-title">
					...
					<div class="d-flex align-items-center position-relative my-1">
						...
						<input type="text" data-kt-Building-table-filter="search"
							class="form-control form-control-solid w-250px ps-13" placeholder="<?php echo e(__('ui.buildings_page.search')); ?>" />
					</div>
					<!--end::Search-->
				</div>
				<!--begin::Card title-->
				...
				<div class="card-toolbar">
					...
					<div class="d-flex justify-content-end" data-kt-Building-table-toolbar="base">
						...
						<button type="button" class="btn btn-light-primary me-3"
							...
							<?php echo e(__('ui.buildings_page.refresh')); ?></button>
						<!--begin::Menu 1-->
						...
						<button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal"
							...
							<i class="ki-duotone ki-exit-up fs-2">
								<span class="path1"></span>
								<span class="path2"></span>
							</i><?php echo e(__('ui.buildings_page.export')); ?></button>
						<!--end::Export-->
						<!--begin::Add Building-->
					...
					<div class="d-flex justify-content-end align-items-center d-none"
						...
						<button type="button" class="btn btn-danger" data-kt-Building-table-select="delete_selected"><?php echo e(__('ui.buildings_page.delete_selected')); ?></button>
					</div>
					<!--end::Group actions-->
						...
						<div class="modal-dialog modal-dialog-centered mw-650px">
							...
							<div class="modal-content">
								...
								<div class="modal-header">
									<!--begin::Modal title-->
									<h2 class="fw-bold"><?php echo e(__('ui.buildings_page.export_buildings')); ?></h2>
									<!--end::Modal title-->
									<!--begin::Close-->
								...
								<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
									...
									<form id="kt_modal_export_buildings_form" class="form" action="#">
										...
										<div class="fv-row mb-10">
											<!--begin::Label-->
											<label class="fs-6 fw-semibold form-label mb-2"><?php echo e(__('ui.buildings_page.select_columns')); ?></label>
											<!--end::Label-->
											<!--begin::Input-->
											<select multiple data-allow-clear="true" data-close-on-select="false"
												name="building_columns[]" data-control="select2"
												data-placeholder="<?php echo e(__('ui.buildings_page.select_columns')); ?>" data-hide-search="false"
										...
										<div class="fv-row mb-10">
											...
											<label class="required fs-6 fw-semibold form-label mb-2">
												<?php echo e(__('ui.buildings_page.export_format')); ?>:</label>
											<!--end::Label-->
											<!--begin::Input-->
											<select name="format" data-control="select2"
												data-placeholder="<?php echo e(__('ui.buildings_page.export_format')); ?>" data-hide-search="false"
												class="form-select form-select-solid fw-bold">
												<option></option>
										...
										<div class="text-center">
											<button type="reset" class="btn btn-light me-3"
												data-kt-buildings-modal-action="close"><?php echo e(__('ui.buildings_page.cancel')); ?></button>
											<button type="submit" class="btn btn-primary"
												data-kt-buildings-modal-action="submit">
												<span class="indicator-label"><?php echo e(__('ui.buildings_page.export')); ?></span>
												<span class="indicator-progress"><?php echo e(__('ui.buildings_page.please_wait')); ?>
				...
				<table class="table  table-rounded  table-striped align-middle table-row-dashed fs-6 gy-5"
					...
					<thead>
						<tr class="text-start text-muted fw-bold border-bottom border-gray-200 fs-7 text-uppercase gs-0">
							...
							<th class="min-w-70px"><?php echo e(__('ui.buildings_page.researcher_name')); ?></th>
							<th class="min-w-70px"><?php echo e(__('ui.buildings_page.survey_status')); ?></th>
							<th class="min-w-70px"><?php echo e(__('ui.buildings_page.building_number')); ?></th>
							<th class="min-w-70px"><?php echo e(__('ui.buildings_page.building_name')); ?></th>
							<th class="min-w-70px"><?php echo e(__('ui.buildings_page.zone_number')); ?></th>
							<th class="min-w-70px"><?php echo e(__('ui.buildings_page.damaged_units_count')); ?></th>
							<th class="min-w-70px"><?php echo e(__('ui.buildings_page.municipality')); ?></th>
							<th class="min-w-70px"><?php echo e(__('ui.buildings_page.district')); ?></th>
							<th class="min-w-70px"><?php echo e(__('ui.buildings_page.updated_at')); ?></th>
							<th class="text-end min-w-100px"><?php echo e(__('ui.buildings_page.action')); ?></th>
						</tr>
					</thead>
