...
?>
<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" dir="<?php echo e($direction); ?>" style="direction: <?php echo e($direction); ?>">
    <head>
        <meta charset="utf-8">
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/font-unified.css')); ?>">
...
<?php /**PATH D:\myProjects\phc\resources\views/layouts/guest.blade.php ENDPATH**/ ?>