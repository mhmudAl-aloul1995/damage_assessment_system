<?php $__env->startSection('title', 'أعضاء اللجنة'); ?>
<?php $__env->startSection('pageName', 'أعضاء اللجنة'); ?>
    ...
    <div class="modal fade" id="committee_member_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <form id="committee_member_form" method="POST" action="<?php echo e(route('committee-members.store')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $('#committee_members_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('committee-members.data')); ?>',
                order: [[4, 'asc']],
                columns: [
                    { data: 'name', name: 'name' },
            ...
            $('#open_committee_member_modal').on('click', function () {
                form.reset();
                form.action = '<?php echo e(route('committee-members.store')); ?>';
            ...
            $(document).on('click', '.committee-member-edit', function () {
                ...
                form.action = '<?php echo e(url('committee-members')); ?>/' + member.id;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\myProjects\phc\resources\views/Committee/Members/index.blade.php ENDPATH**/ ?>