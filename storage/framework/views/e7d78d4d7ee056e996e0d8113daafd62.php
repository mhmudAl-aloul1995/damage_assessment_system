...
<body>
    ...
    <div class="report-shell">
        <div class="report-header">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoDataUri): ?>
                <div class="report-brand">
                    <img src="<?php echo e($logoDataUri); ?>" alt="PHC Logo" class="report-logo">
                </div>
