...
return [
    ...
    'section_labels' => [
        ...
        'technical_assessment' => [
            'title' => 'تقييم المأوى - الحالة الفنية العامة',
            'description' => 'الأضرار العامة، المساحة، الغرف، والعناصر الفنية الأساسية للمأوى.',
        ],
        'social_assessment' => [
            'title' => 'تقييم المعيشة - الدخل والخصوصية',
        ...
        'group_8m8lj61' => [
            'title' => 'تقييم المعيشة - الاحتياجات الأساسية',
            'description' => 'الدخل، العمل، المساعدات الغذائية، الاحتياجات الأساسية، والخصوصية.',
        ],
        'group_fj7vq52' => [
            'title' => 'تفاصيل حالة المأوى والمرافق',
        ...
        'group_un2xy00' => [
            'title' => 'صور المستندات المتوفرة',
            'description' => 'صور المستندات المتوفرة للمستفيد.',
        ],
        'group_lm1ok19' => [
            'title' => 'صور الوحدة والمبنى',
