...
DELETE ea
FROM
    edit_assessments AS ea
WHERE
    ea.type = 'building_table'
    AND ea.global_id IN (
...
FROM
    ...
    INNER JOIN buildings AS b ON b.objectid = bs.building_id
WHERE
    b.globalid IN (
        '51ea2320-1c6b-4115-af83-e8103cb335c0',
        '6480b68c-c0c7-4411-9f5d-3060cf30725c',
...
DELETE au
FROM
    assigned_assessment_users AS au
    INNER JOIN buildings AS b ON b.objectid = au.building_id
WHERE
    b.globalid IN (
        '51ea2320-1c6b-4115-af83-e8103cb335c0',
        '6480b68c-c0c7-4411-9f5d-3060cf30725c',
