...
namespace App\Http\Controllers\FieldEngineer;
...
class BuildingSurveyReturnRequestController extends Controller
{
    public function index(): View
    {
        ...
        return view('building_survey_return_requests.index', compact('requests', 'buildings'));
    }
    ...
    public function create(): View
    {
        ...
        return view('building_survey_return_requests.create', compact('buildings'));
    }
    ...
    public function show(BuildingSurveyReturnRequest $returnRequest): View
    {
        ...
        return view('building_survey_return_requests.show', compact('returnRequest', 'areaManagers'));
    }
