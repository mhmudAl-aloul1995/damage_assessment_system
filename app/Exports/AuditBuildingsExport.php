...
class AuditBuildingsSheet extends AuditSheet
{
    ...
    public function map($row): array
    {
        ...
        $values = [
            ...
            'engineer' => $engineer,
            'lawyer' => $lawyer,
            'engineering_auditor' => $building->engineerStatus?->user?->name ?? $engineer,
            'legal_auditor' => $building->lawyerStatus?->user?->name ?? $lawyer,
            ...
            'engineering_notes' => $building->engineerStatus?->notes,
            'legal_notes' => $building->lawyerStatus?->notes,
...
class AuditHousingUnitsSheet extends AuditSheet
{
    ...
    public function map($row): array
    {
        ...
        $values = [
            ...
            'engineering_auditor' => $unit->engineerStatus?->user?->name,
            'legal_auditor' => $unit->lawyerStatus?->user?->name,
            ...
            'engineering_notes' => $unit->engineerStatus?->notes,
            'legal_notes' => $unit->lawyerStatus?->notes,
