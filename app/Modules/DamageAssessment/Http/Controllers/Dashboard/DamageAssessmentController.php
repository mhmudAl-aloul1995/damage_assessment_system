...
class DamageAssessmentController extends Controller
{
    ...
    public function index(Request $request, $objectid = null): ViewResponse|RedirectResponse
    {
        ...
        $buildingStats = [
            ...
            'assessed_total' => (int) $data['buildings']->fully_damaged + (int) $data['buildings']->partially_damaged + (int) $data['buildings']->committee_review,
    ...
    public function latestStats(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        return response()->json([
            'buildingStats' => [
                ...
                'assessed_total' => (int) $buildings->fully_damaged + (int) $buildings->partially_damaged + (int) $buildings->committee_review,
