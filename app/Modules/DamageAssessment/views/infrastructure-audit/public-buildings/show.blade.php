        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="inf_audit_main_tab" role="tabpanel">
                    @include('damage-assessment::infrastructure-audit.public-buildings._audit_sections', [
                        ...
                        <div class="card card-flush border shadow-sm mb-6">
                            ...
                            <div class="card-body">
                                @foreach ($group['sections'] as $section)
                                    @include('damage-assessment::infrastructure-audit.public-buildings._field_table', ['section' => $section])
                                @endforeach
                            </div>
                        </div>
                    @empty
