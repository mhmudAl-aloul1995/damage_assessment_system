...
it('renders the hud arcgis map filter controls', function () {
    ...
    $response
        ...
        ->assertSee("position: 'top-center'", false)
        ...
        ->assertSee('id="hudBoundaryMode"', false)
        ->assertSee('<option value="governorates" selected>المحافظات</option>', false)
        ->assertSee('<option value="neighborhoods">المناطق</option>', false)
        ->assertSee('<option value="none">بدون حدود</option>', false)
        ->assertSee('governoratesBoundaryLayerUrl', false)
        ->assertSee('neighborhoodsBoundaryLayerUrl', false)
        ->assertSee('createBoundaryLayer', false)
        ->assertSee('applyBoundaryRenderer', false)
        ->assertSee("event.target.value === 'governorates'", false)
        ->assertSee("event.target.value === 'neighborhoods'", false)
