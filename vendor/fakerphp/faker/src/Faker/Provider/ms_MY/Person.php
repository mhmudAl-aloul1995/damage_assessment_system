...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstNameMaleIndian = [
        ...
        'Ganesh', 'Ganga', 'Gengadharan', 'Gobalakrishnan', 'Gobind', 'Gopinathan', 'Govphcamy', 'Gunasekaran', 'Gurmit',
    ...
    protected static $lastNameIndian = [
        ...
        'Elavarasan',
        'Fernandes', 'Fernandez',
        'Ganapathy', 'Ganesan', 'Gnanalingam', 'Goundar', 'Govphcamy', 'Gunalan', 'Gurusamy',
        'Haridas',
        'Iyer',
